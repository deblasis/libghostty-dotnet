...
namespace Ghostty.Unity
{
    ...
    public struct ghostty_runtime_config_s
    {
        ...
        public ghostty_runtime_wakeup_cb wakeup_cb;
        [MarshalAs(UnmanagedType.FunctionPtr)]
        public ghostty_runtime_action_cb action_cb;
        [MarshalAs(UnmanagedType.FunctionPtr)]
        public ghostty_runtime_read_clipboard_cb read_clipboard_cb;
        [MarshalAs(UnmanagedType.FunctionPtr)]
        public ghostty_runtime_confirm_read_clipboard_cb confirm_read_clipboard_cb;
        [MarshalAs(UnmanagedType.FunctionPtr)]
        public ghostty_runtime_write_clipboard_cb write_clipboard_cb;
        [MarshalAs(UnmanagedType.FunctionPtr)]
        public ghostty_runtime_close_surface_cb close_surface_cb;
    }
    ...
    public static class GhosttyNative
    {
        ...
        private const string BridgeLib = "GhosttyBridge";

        // -- Ghostty lifecycle --

        [DllImport(GhosttyLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern int ghostty_init();
        ...
        [DllImport(GhosttyLib, CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool ghostty_app_tick(IntPtr app);
        ...
        [DllImport(GhosttyLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ghostty_surface_resize_shared_texture(
            IntPtr surface,
            uint width,
            uint height);
        ...
        [DllImport(GhosttyLib, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ghostty_app_set_focus(
            IntPtr surface,
        ...
        // -- Bridge plugin (D3D11 shared texture interop) --

        [DllImport(BridgeLib, CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr GhosttyBridge_OpenSharedTexture(
            IntPtr sharedHandle,
            uint width,
            uint height);

        [DllImport(BridgeLib, CallingConvention = CallingConvention.StdCall)]
        public static extern void GhosttyBridge_ReleaseSRV(IntPtr srv);

        [DllImport(BridgeLib, CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr GhosttyBridge_GetDevice();
    }
}
